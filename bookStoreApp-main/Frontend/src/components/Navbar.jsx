...
function Navbar() {
  ...
  useEffect(() => {
    const fetchFilteredBooks = () => {
      ...
      const finalFiltered = authUser ? filtered : filtered.filter(book => book.price === 0);
      setFilteredBooks(finalFiltered);
    };
    fetchFilteredBooks();
  }, [searchTerm, allBooks, authUser]);
      ...
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky ? 'sticky-navbar shadow-md bg-base-200 dark:bg-slate-700 dark:text-white duration-300 transition-all ease-in-out' : ''}`}>
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer">Literary Lane</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              ...
              {filteredBooks.length > 0 && (
                <div className="absolute bg-white dark:bg-slate-700 dark:text-white shadow-lg rounded-lg mt-2 w-full max-w-md">
                  {filteredBooks.map((book) => (
                    ...
                    >
                      <div className="flex items-center">
                        <img src={book.image} alt={book.name} className="w-12 h-12 object-cover mr-2" />
                        <div>
            ...
            {authUser ? (
             <>
             <Logout />
             <NavLink to="/wishlist" className="text-2xl">
